...
return [
    ...
    'title' => config('SkillBridge').' API Documentation',
    ...
    'auth' => [
        ...
        'extra_info' => 'Masukkan token Sanctum pada kolom Authorization dengan format <code>Bearer TOKEN</code>. Gunakan token user untuk endpoint user dan token admin untuk endpoint admin.',
    ],
